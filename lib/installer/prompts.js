...
const EVOLUTI_TEAM = [
  'revoluti-conselheiro',
  'revoluti-construtor',
  'revoluti-dominio',
  'revoluti-modulo',
  'revoluti-orquestrador',
  'revoluti-verificador',
];
...
export const PRODUCT_STRATEGY_AGENT_IDS = PRODUCT_STRATEGY_TEAM;
export const EVOLUTI_AGENT_IDS = EVOLUTI_TEAM;

const TEAM_TO_AGENTS = {
  migration: MIGRATION_TEAM,
  forward: FORWARD_TEAM,
  product_strategy: PRODUCT_STRATEGY_TEAM,
  translators: TRANSLATORS,
  pricing: PRICING_TEAM,
  evoluti: EVOLUTI_TEAM,
};
...
export async function runInstallPrompts(detectedEngines) {
  ...
  const teamChoices = [
    ...
    { name: 'Product Strategy Agents', value: 'product_strategy', checked: true },
    { name: 'Translators N8N->Specs->Python', value: 'translators', checked: false },
    { name: 'Evoluti Agents (create new products)', value: 'evoluti', checked: false },
  ];
