...
const AGENT_LABELS = {
  ...
  'reversa-brief':            'Brief: LLM-ready repository context pack (/reversa-brief)',
  'reversa-evolve':           'Evolve: product expansion workflow from analyzed specs (/reversa-evolve)',
  'reversa-extract-soul':     'Extract Soul: compatibility alias for Reversa Brief (/reversa-extract-soul)',
